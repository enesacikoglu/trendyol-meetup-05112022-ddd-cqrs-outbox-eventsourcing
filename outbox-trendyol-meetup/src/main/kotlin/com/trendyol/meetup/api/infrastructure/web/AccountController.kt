...
import com.trendyol.meetup.api.application.commands.MoneyWithdrawFromAccountCommand
...
class AccountController(private val commandBus: CommandBus) {
    ...
    @PutMapping
    fun withdrawFromAccount(@RequestBody moneyWithdrawFromAccountCommand: MoneyWithdrawFromAccountCommand) {
        commandBus.executeCommand(moneyWithdrawFromAccountCommand)
    }
